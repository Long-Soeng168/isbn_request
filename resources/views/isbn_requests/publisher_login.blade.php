...
@section('content')
    ...
    <main class="flex overflow-x-hidden">
         <div class="flex-col items-center justify-center flex-1 hidden gap-6 bg-white md:flex">
            <h2 class="text-4xl lg:text-6xl text-[#5D54A4] max-w-[60ch] text-center font-bold">ISBN Management System</h2>
            <img class="w-[60ch] px-8" src="{{ asset('assets/icons/isbnimage.jpg') }}" alt="">
         </div>
         <div class="flex-1 shrink-0 container_login_form">
            <div class="screen">
                <div class=" screen__content">
                    ...
                    <h3 class="flex justify-end px-8 mt-20">
                        <a class="flex gap-2 text-sm text-white rounded-md focus:outline-none whitespace-nowrap"
                            href="{{ url('publisher_register') }}">
                            <span>{{ __('Don\'t Has Account? ') }} </span>
                            <strong class="underline hover:underline-offset-4">Sign Up</strong>
                        </a>
                    </h3>
